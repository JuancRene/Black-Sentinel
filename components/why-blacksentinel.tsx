...
export function WhyBlackSentinel() {
  ...
  return (
    ...
    >
      ...
      {/* Glow central */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#0AB9C3]/5 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#0AB9C3]/30 bg-[#0AB9C3]/5 backdrop-blur-md shadow-[0_0_15px_-3px_rgba(10,185,195,0.2)] mb-6">
            ...
            <span className="text-xs font-semibold text-[#0AB9C3] uppercase tracking-wider">Evolución de la Seguridad</span>
          </div>

          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6 tracking-tight">
            La diferencia es <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#0AB9C3] to-teal-500">humana</span>
          </h2>
        ...
        >
            <div className="relative rounded-3xl border border-zinc-800 bg-[#0A0A0A]/80 backdrop-blur-sm overflow-hidden">
                ...
                <div className="grid grid-cols-12 border-b border-zinc-800 bg-zinc-900/50">
                    ...
                    <div className="col-span-6 md:col-span-4 p-6 text-center border-l border-zinc-800 bg-[#0AB9C3]/5 relative overflow-hidden">
                        <div className="absolute top-0 left-0 right-0 h-1 bg-[#0AB9C3] shadow-[0_0_15px_#0AB9C3]" />
                        <div className="text-xs font-mono text-[#0AB9C3] uppercase tracking-widest mb-2 flex justify-center items-center gap-2">
                             Active Defense <span className="w-2 h-2 rounded-full bg-[#0AB9C3] animate-pulse"></span>
                        </div>
                ...
                {comparison.map((row, idx) => (
                    <div key={idx} className="grid grid-cols-12 border-b border-zinc-800/50 hover:bg-white/[0.02] transition-colors last:border-0 group">
                        ...
                        {/* BlackSentinel Value */}
                        <div className="col-span-6 md:col-span-4 p-4 md:p-6 flex items-center justify-center text-center border-l border-zinc-800/50 bg-[#0AB9C3]/[0.02]">
                            <div className="flex flex-col items-center gap-2">
                                <span className="text-sm font-bold text-white">{row.blacksentinel}</span>
                                <Check className="w-4 h-4 text-[#0AB9C3]" />
                            </div>
                        </div>
                    </div>
                ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto">
          {benefits.map((benefit, index) => {
            ...
            return (
              ...
              >
                {/* Border Hover Effect */}
                <div className={`absolute inset-0 border-2 border-[#0AB9C3] rounded-2xl opacity-0 transition-opacity duration-300 pointer-events-none ${
                    isHovered ? "opacity-100" : ""
                }`} />

                {/* Background Hover Glow */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#0AB9C3]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

                <div className="relative z-10 flex flex-col items-start">
                    {/* Icon Box */}
                    <div className="mb-6 relative">
                        <div className="w-14 h-14 bg-zinc-900 rounded-xl flex items-center justify-center border border-zinc-700 group-hover:border-[#0AB9C3] group-hover:bg-[#0AB9C3] transition-all duration-300">
