  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-primary/15 rounded-full blur-[180px] animate-pulse-glow" />
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl sm:text-2xl md:text-3xl text-gray-300 mb-10 max-w-3xl mx-auto leading-relaxed">
                ...
                <span className="text-primary font-bold">Sin estrés. Sin incidentes.</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center justify-center gap-2">
                    <Sparkles className={`w-5 h-5 transition-transform duration-300 ${isHoveringPrimary ? "rotate-180" : ""}`} />
                    Empezar ahora
